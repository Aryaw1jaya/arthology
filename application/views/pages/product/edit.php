					...
					<div class="col-5">
						<div class="form-group">
							...
							<select class="form-control" name="edition">
								...
								<option value="paintings" <?php if($product['edition'] == "paintings"){ print ' selected'; }?>>Paintings</option>
								<option value="sculptures" <?php if($product['edition'] == "sculptures"){ print ' selected'; }?>>Sculptures</option>
								<option value="furniture" <?php if($product['edition'] == "furniture"){ print ' selected'; }?>>Furniture</option>
							</select>
						</div>
					</div>
				</div>
